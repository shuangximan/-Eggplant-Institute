...
//配置域名,域名只修改此处。
//如果wordpress没有安装在网站根目录请加上目录路径,例如："q-z.top/blog"
var DOMAIN = "q-z.top";
var MINAPPTYPE="0";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME ="茄子研究所"; //网站名称
var ABOUTID = 123; //wordpress网站"页面"的id,注意这个"页面"是wordpress的"页面"，不是"文章"
...
var ZANIMAGEURL = 'https://q-z.top/wp-content/uploads/2018/02/wechatpay.png';//微信赞赏的图片链接，用于个人小程序的赞赏
 //首页图标导航
...
var INDEXNAV = [
    ...
    { id: '4', name: '网站', image: '../../images/logo-icon.png', url: 'https://q-z.top', redirecttype: 'webpage', appid: '', extraData: '' }
    ]
